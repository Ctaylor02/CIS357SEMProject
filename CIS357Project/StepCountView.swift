...
struct StepCountView: View {
    ...
    var body: some View {
        ...
        ZStack {
            ...
            LinearGradient(colors: [Color.blue.opacity(0.25), Color.purple.opacity(0.2)],
            ...
            VStack(spacing: 40) {
                ...
                VStack(spacing: 20) {
                    ...
                    Text(selectedPeriod.displaySteps(from: viewModel))
...
enum StepPeriod: CaseIterable {
    ...
    func displaySteps(from viewModel: WorkoutViewModel) -> String {

        switch self {

        case .daily:

            return String(viewModel.dailySteps)

        case .weekly:

            return String(viewModel.weeklySteps)

        case .monthly:

            return String(viewModel.monthlySteps)
