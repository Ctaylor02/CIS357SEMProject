        ...
        ZStack {
            ...
            VStack(spacing: 40) {
                ...
                VStack(spacing: 20) {
                    ...
                    let stepCount = selectedPeriod.displaySteps(from: viewModel)
...
enum StepPeriod: CaseIterable {
    ...
    func displaySteps(from viewModel: WorkoutViewModel) -> String {
        switch self {
        case .daily: return String(viewModel.dailySteps)
        case .weekly: return String(viewModel.weeklySteps)
        case .monthly: return String(viewModel.monthlySteps)
        }
    }
}
